 ...
 */
package JSON_LecturaEscritura.Ejemplos;
...
public class ObjetoAFichero {
    public static void main (String args []) throws IOException{
        ...
        try (FileWriter writer = new FileWriter("./ficheros/personaConAsig.json")) {
    ...
    public static void GuardarJSON(String json){
        try (
            BufferedWriter bw = new BufferedWriter(new FileWriter("./ficheros/personaConAsig.json"))) {
            bw.write(json);
